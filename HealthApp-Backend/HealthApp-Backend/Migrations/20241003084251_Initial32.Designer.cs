...
namespace HealthApp_Backend.Migrations
{
    ...
    [Migration("20241003084251_Initial32")]
            ...
            modelBuilder.Entity("HealthApp_Backend.Models.DomainModels.ShoppingList", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("3b2cc595-b071-4602-82e5-869f58e84ab7"),
                            CreatedOn = new DateTime(2024, 10, 3, 10, 42, 50, 117, DateTimeKind.Local).AddTicks(7882),
                            KcalGoal = 2000,
                            UserId = new Guid("3b2cd595-b071-4602-82e5-869f58e84ab7"),
                            kcalCurrent = 0,
                            kcalMax = true,
                        ...
                        {
                            Id = new Guid("4eae13c3-408a-42e0-b334-d61c9ad99077"),
                            CreatedOn = new DateTime(2024, 10, 3, 10, 42, 50, 121, DateTimeKind.Local).AddTicks(1096),
                            KcalGoal = 2000,
                            UserId = new Guid("3b2cd595-b071-4602-82e5-869f58e84ab7"),
                            kcalCurrent = 0,
                            kcalMax = true,
                        ...
                        {
                            Id = new Guid("dbaf0f17-3886-4954-a093-c0872fb3c8c1"),
                            CreatedOn = new DateTime(2024, 10, 3, 10, 42, 50, 121, DateTimeKind.Local).AddTicks(1135),
                            KcalGoal = 2000,
                            UserId = new Guid("3b2cd595-b071-4602-82e5-869f58e84ab7"),
                            kcalCurrent = 0,
                            kcalMax = true,
                        ...
                        {
                            Id = new Guid("75bbd1bb-9b67-40ad-bac4-c38fdbf86c02"),
                            CreatedOn = new DateTime(2024, 10, 3, 10, 42, 50, 121, DateTimeKind.Local).AddTicks(1140),
                            KcalGoal = 2000,
                            UserId = new Guid("3b2cd595-b071-4602-82e5-869f58e84ab7"),
                            kcalCurrent = 0,
                            kcalMax = true,
